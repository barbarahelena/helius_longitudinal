...
ggplot(data = dftot3 %>% filter(!is.na(EthnicityTot)), 
    ...
    stat_compare_means(comparisons = comp, tip.length = 0, hide.ns = TRUE, label.x = 1.5,
                       label = "p.signif", method = "wilcox.test") +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_ethnicities_time.pdf", width = 6, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(HT_BPMed)), aes(x = HT_BPMed, y = shannon_delta)) +
    ...
    #                    label = "p.signif") +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_hypertension.pdf", width = 4, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(DM)), aes(x = DM, y = shannon_delta)) +
    ...
    #                    label = "p.signif") +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_dm.pdf", width = 4, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(MetSyn)), aes(x = MetSyn, y = shannon_delta)) +
    ...
    #                    label = "p.signif") +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_metsyn.pdf", width = 4, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(HbA1c_delta)), aes(x = shannon_delta, y = HbA1c_delta)) +
    ...
    stat_cor() +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_deltahba1c.pdf", width = 6, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(LDL_delta)), aes(x = shannon_delta, y = LDL_delta)) +
    ...
    stat_cor() +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_deltaldl.pdf", width = 6, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(Age)), aes(x = shannon_delta, y = Age)) +
    ...
    stat_cor() +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/shannon_deltaage.pdf", width = 6, height = 5)
...
ggplot(data = dftot %>% filter(!is.na(BMI_delta)), aes(x = shannon_delta, y = BMI_delta)) +
    ...
    stat_cor() +
    theme_Publication()
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_shannon_deltabmi.pdf", width = 6, height = 5)
...
(pl1 <- dftot2 %>% filter(!is.na(DM_new)) %>%  ggplot() +
        ...
        labs(x = "Timepoint", y = "Shannon index", title = "New diabetes diagnoses",
             color = ""))
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_diabetes_deltashannon.pdf", width = 4, height = 4)
...
(pl1 <- dftot2 %>% filter(!is.na(DM_new)) %>%  ggplot() +
        ...
        labs(x = "Timepoint", y = "Richness", title = "New diabetes diagnoses",
             color = ""))
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_diabetes_deltarichness.pdf", width = 4, height = 4)
...
(pl2 <- dftot2 %>% filter(!is.na(HT_new)) %>%  ggplot() +
        ...
        labs(x = "Timepoint", y = "Shannon index", title = "New hypertension diagnoses",
             color = ""))
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_hypertension_deltashannon.pdf", width = 4, height = 4)
...
(pl2 <- dftot2 %>% filter(!is.na(MetSyn_new)) %>%  ggplot() +
        ...
        labs(x = "Timepoint", y = "Shannon index", title = "New MetSyn diagnoses",
             color = ""))
ggsave("results/3_species_change/1_comparison_16s/alphadiversity/sg_metsyn_deltashannon.pdf", width = 4, height = 4)
