# Ethnicity prediction (baseline + follow-up): XGBoost input
...
head(tabba)
write.csv2(tabba, file = "results/3_species_change/5_mlmodels/wilcoxon_ethbase_shotgun.csv")

mbdf <- mbdf[,2:ncol(mbdf)]
path <- 'results/3_species_change/5_mlmodels/eth_base'
dir.create(path, showWarnings = FALSE, recursive = TRUE)
dir.create(file.path(path, "input_data"), showWarnings = FALSE)
...
head(tabfu)
write.csv2(tabfu, file = "results/3_species_change/5_mlmodels/wilcoxon_ethfu_shotgun.csv")
