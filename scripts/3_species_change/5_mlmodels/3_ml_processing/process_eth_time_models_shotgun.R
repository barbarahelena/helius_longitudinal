...
## Baseline
path_true <- latest_output("results/3_species_change/5_mlmodels/eth_base", "output_XGB")
data_path <- "results/3_species_change/5_mlmodels/eth_base/input_data"
labels <- c("SAS", "Dutch")
...
ggsave(plarr1, filename = "results/3_species_change/5_mlmodels/shotgun_ethnicity_baseline.pdf",
       width = 14, height = 18)

## Follow-up
path_true <- latest_output("results/3_species_change/5_mlmodels/eth_fu", "output_XGB")
data_path <- "results/3_species_change/5_mlmodels/eth_fu/input_data"
labels <- c("SAS", "Dutch")
...
plarr1 <- ggarrange(svg_grob, pl2, pl3,
                    nrow = 3, labels = c("A", "B", "C"),
                    heights = c(1.2,1.3,0.8))
ggsave(plarr1, filename = "results/3_species_change/5_mlmodels/shotgun_ethnicity_followup.pdf",
       width = 14, height = 18)


#### Figure 3A — Ethnicity prediction panel (baseline + follow-up) ####

path_eth_base <- latest_output("results/3_species_change/5_mlmodels/eth_base", "output_XGB")
path_eth_fu   <- latest_output("results/3_species_change/5_mlmodels/eth_fu", "output_XGB")
