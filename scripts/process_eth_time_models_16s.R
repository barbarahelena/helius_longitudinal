...
ggsave(plarr1, filename = "results/ml_figures/16s_comp_timepoint.pdf",
       width = 14, height = 18)
...
plarr1 <- ggarrange(ggarrange(svg_grob), pl2, pl3,
                    nrow = 3, labels = c("A", "B", "C"), 
                    heights = c(1.2,1.3,0.8))
ggsave(plarr1, filename = "results/ml_figures/16s_comp_timepoint_dutch.pdf",
       width = 14, height = 18)
...
plarr1 <- ggarrange(ggarrange(svg_grob), pl2, pl3,
                    nrow = 3, labels = c("A", "B", "C"), 
                    heights = c(1.2,1.3,0.8))
ggsave(plarr1, filename = "results/ml_figures/16s_comp_timepoint_sas.pdf",
       width = 14, height = 18)
...
plarr1 <- ggarrange(ggarrange(svg_grob), pl2, pl3,
                    nrow = 3, labels = c("A", "B", "C"), 
                    heights = c(1.2,1.3,0.8))
ggsave(plarr1, filename = "results/ml_figures/16s_ethnicity_baseline.pdf",
       width = 14, height = 18)
...
plarr1 <- ggarrange(ggarrange(svg_grob), pl2, pl3,
                    nrow = 3, labels = c("A", "B", "C"), 
                    heights = c(1.2,1.3,0.8))
ggsave(plarr1, filename = "results/ml_figures/16s_ethnicity_followup.pdf",
       width = 14, height = 18)
