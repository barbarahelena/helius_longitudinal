#!/usr/bin/env python3
"""
Creates a samplesheet for all Alistipes bins across 3 assembly batches.
Output: data/alistipes_samplesheet.csv with columns: bin, path
"""
...
OUTPUT = "data/alistipes_samplesheet.csv"

rows = []
missing = []

for batch in BATCHES:
    csv_path = os.path.join(BASE, batch, "GenomeBinning", "bins_alistipes.csv")
