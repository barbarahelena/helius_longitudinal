#!/usr/bin/env python3
"""
Creates a samplesheet for all Senegalimassilia bins across 3 assembly batches.
...
OUTPUT = "data/senegalimassilia_samplesheet.csv"

rows = []
missing = []

for batch in BATCHES:
    csv_path = os.path.join(BASE, batch, "GenomeBinning", "Senegalimassilia_bins.csv")
